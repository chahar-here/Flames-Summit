...
//         className="h-4 w-4 rounded-full border border-red-500 bg-gradient-to-b from-red-500 to-red-500"
//       />
//       <motion.div
//         initial={{
//           y: 0,
...
//         className="h-4 w-4 rounded-full border border-white bg-gradient-to-b from-white to-white"
//       />
//       <motion.div
//         initial={{
//           y: 0,
...
export const LoaderOne = () => {
  const transition = (x: number) => {
    return {
      ...
      repeatType: "loop" as const,
      delay: x * 0.2,
      ease: "easeInOut" as const, // --- THIS IS THE FIX ---
    };
  };
  return (
    <div className="flex items-center gap-2">
