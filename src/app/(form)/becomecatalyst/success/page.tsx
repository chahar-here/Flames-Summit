        ...
        {showPopup && (
          ...
          >
            <div className="flex flex-col items-center">
              ...
              {/* 🔥 Red headline for Catalyst */}
              <h1 className="text-2xl font-bold text-red-500 mb-2">
                Catalyst Application Submitted 🎉
              </h1>

              <p className="text-gray-300 mb-4">
                Thank you for your interest in becoming a{" "}
                <strong className="text-red-400">Flames Catalyst</strong>.
              </p>

              <p className="text-gray-400">
                Our team will carefully review your profile and get in touch with you soon.
